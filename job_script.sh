...
./Rsample_all_cluster.sh smHotair 180 60 > smHotair_180_60.out 2> smHotair_180_60.error
./Rsample_all_cluster.sh hSRA 181 61 > hSRA_181_61.out 2> hSRA_181_61.error
./Rsample_all_cluster.sh mSRA 181 61 > mSRA_181_61.out 2> mSRA_181_61.error
./Rsample_all_cluster.sh ROX2 181 61 > ROX2_181_61.out 2> ROX2_181_61.error
